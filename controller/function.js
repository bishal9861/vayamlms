...
exports.sendOtpFunction = async (req, res, next) => {
    ...
    var options = { authorization: apikey, message: `Your OTP is :${otpval}`, numbers: [phNumber] }
...
exports.getMiTestQ = (req, res, next) => {
    Question.find().then(
        questions => {
            console.log(questions.length)
            res.render("miTestQ.ejs", {
                Questions: questions
            })
